(function() {
    ...
    (function MakeSys() {
        ...
        (function pure(sys, make, unit, $const, bin, extract, wrap, pure, create, log) {
        ...
        (function(pure) {
            ...
            (function MakeArray() {
                ...
                this.prototype.prepend = function() {
                    return (0*this.unshift.apply(this, [].slice.call(arguments).flatten())) || this;
                };
                this.prototype.append = function() {
                    return (0*this.push.apply(this, [].slice.call(arguments).flatten())) || this;
                };  
            }).call(Array)
        ),
        ...
        (function(make) {
            ...
            (function(sys) {
                ...
                this.is = function(v) {
                    return v && v instanceof sys.base ? true : false;
                };
    ...
    (function MakeKlass() {
        ...
        (function base(init, make, next) {
            ...
            node.child('Data').parse({ def: data.get(), type: data });
            node.child('Store').parse({ def: store.get(), type: store });
                            ...
                            klass: function(def) {
                                return function() {
                                    ...
                                    if (!def.super && def.parent) {
                                        def.parent = this.of((def.super = def.parent)).make();
                                        if (!def.parent.get('proto').ctor) {
                                            def.parent.get('proto').ctor = def.parent.get('klass');
                                        }
                                    }
            ...
            (function() {
                return {
                    ...
                    ext: [
                        ...
                        (function push(val) {
                            return val[(val.push([])-1)];
                        }),
                        (function add(item) {
                            if (this._uid%10==0) this._val = null;
                            item._uid = this._uid++;
                            return this.push(this._val || (this._val = this.locate(this._uid)));
                        })
                    ],
                    attrs: [
                        (function of() {
                    ...
                    ext: [
                        ...
                        (function clear(id) {
                            ...
                            if (!node || !node.length || !node.length()) {
                                ...
                                idxs = node.base('values')(node._map),
                                keys = node.base('keys')(node._map),
                                pos  = 0,
                                del  = [];
                        ...
                        (function find(value) {
                            return this.db.find(typeof value == 'object' ? (value._uid || value._id || value.uid) : value).first();
                        }),
                        (function info(recur) {
                    ...
                    init: (function(wrap, make, ext) {
                        return function(type, klass, sys) {
                            return ext(make.call(wrap({
                                ...
                                utils: sys.root.get('utils').select('andThen', 'call', 'call1', 'call2'),
                                async: sys.root.get('async').select('pure', 'get', 'next', 'combine', 'flatmap', 'fmap', 'wrap', 'then', 'lazyR', 'lazyK')
                            })));
                        };
                    })(
                        (function(ext) {
                    ...
                    ext: [
                        (function init(opts) {
                            ...
                            if (opts.parent) {
                                ...
                                if ((this._store = this._parent.get(this._cid))) {
                        ...
                        (function($get, $wrap) {
                            return function get() {
                                return $wrap(this, $get(this, [].slice.call(arguments).join('.')));
                            }
                        })(
                            ...
                            (function wrap(node, value) {
                                return value && value._ref && node.is(value._ref) ? value._ref : value;
                            })
                        ),
                        (function set(key, value) {
                            return key && key.indexOf && key.indexOf('.') > 0
                            ? (this._store.path(key)
                        ...
                        (function observe(/* name, selector, handler */) {
                            return this.store().dispatcher.addEventListener.apply(this.store().dispatcher, [ this, 'store' ].concat([].slice.call(arguments)));
                        }),
                        ...
                        (function child(opts, ctor, parent) {
                            ...
                            return parent.set(instance._cid, instance.store()).ref();
                        }),
                        ...
                        (function clear(id) {
                            return this._store.clear(id).ref();
                        }),
                        (function add(name) {
                ...
                return {
                    ...
                    ext: [
                        ...
                        (function run(value) {
                            ...
                            vals.push(value);
                            return this._kont.run(function() {
                                vals.splice(0);
                            });
                        })
                    ],
        ...
        // === Event === //
            (function() {
                return {
                    ...
                    ext: [
                        ...
                        (function initQueue(queue) {
                            return queue.bind(function(value) {
                                return {
                                    ...
                                    ref:     value.source.identifier(true).slice(value.source.level()-1).join('.'),
                        ...
                        (function emit(source, args) {//* source, name, target, info */) {
                            if (args !== 'queue' && source && source.uid && this._active) {
                                if (this._queue.push({ eid: this.eid(), count: 0, source: source, args: args })) {
                                    this.runQueue();
                                }
                            }
                        }),
                    ...
                    init: function(type, klass, sys) {
                        var Root = sys.root; klass.prototype.isEvents = true; klass.prototype.eid = this.makeID();
                        var Events = Root.__.prototype.events  = klass.prototype.events = Root.child('events', klass);//klass.of(type, klass));
                        Events.initdata();
                    }
                };
            }),
                ...
                return {
                    ...
                    ext: (function() {
                        ...
                        (function(mbAddEL1, mbAddEL2, mbELEMListener, addELEMENTListener,
                            ...
                            return [
                                { name: 'mainQueue', fn: this.root.child('queue', this.type('Queue').get('klass')) },
                        ...
                        (function init(type) {
                            ...
                            return function(elem) {
                                ...
                                var disp = node.get('dispatcher')
                                    || node.set('dispatcher', func.wrapDispatcher(node.store().wrap()));

                                return lift(function(node, name) {
                                    return node.get(name)
                                        || node.store().make(node.identifier(), name, node.get('dispatcher')(node.get('listener'))(name));
                                }, ctor.walk('pure').call(ctor, node));
                            }
                        })
                    ],
                    data: {
                        ...
                        store: [
                            (function matches(element, selector) {
                                return function(evt) {
                                    if (evt && evt.target && (!selector || evt.target.matches(selector.replace(evt.src+'.', '')))) {
                                        if (!element) return true;
                    ...
                    init: function(type, klass, sys) {
                        var lift  = klass.lift = sys.root.get('utils.lift');
                        var func  = klass.prototype;
                        var maybe = sys.root.get('utils.maybe');
                        var bin   = sys.root.get('utils.bin');
                        var pure  = klass.pure = this.get('parent').klass.pure;
                        ...
                        this.find('Store').get('klass').prototype.dispatcher = klass.init('store')(sys.root);
                    }
                };
            }),
        // === Location === //
                ...
                return {
                    ...
                    ext: [
                        ...
                        (function parse(conf) {
                            ...
                            this._data = this._data ? this._data.clear() : this.node('data').parse({ id: this.uid() });
                        ...
                        (function eff(name) {
                            return this.$eff[name];
                        }),
                        (function start() {
                            if (!this._started && (this._started = true)) {
                                sys.log('!START!', this.identifier());
                                this.observe('change', 'data.%', this.change.bind(this));
                            }
                        }),
                        (function change(evt) {
                            console.log(evt);
                    ...
                    init: function(type, klass) {
                        ...
                        klass.prototype._node = sys.get().child('components');
                        sys.klass('Events');
                        sys.klass('Listener');
                    }
                };
                        ...
                        (function script() {
                            ...
                            (function extend(store) {
                                ...
                                return function(result) {
                                    ...
                                    if (result.data) {
                                        proto.conf.data = sys.get('utils.extend')(proto.conf.data || {}, result.data);
                                    }
                ...
                return {
                    ...
                    loader: [
                        ...
                        (function component(name) {
                            var cont = sys.eff('io.request.script').run([ 'components', name, name ].join('/'));
                            var type = name.toTypeName();
