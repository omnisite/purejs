// ========  ========= PURE JS ====== ========  ======== //
    ...
    (function MakeApp() {
        ...
        return [].slice.call(arguments).next(unit).slice(3).call();
    })(
    ...
    // === ReadInitialTypes === //
    (function() {
        return [].slice.call(arguments).next(unit).call();
    })(
        // === Essentials === //
        (function() {
        ...
        (function() {
            return [].slice.call(arguments).next(unit).reduce(function(r, v, i) {
