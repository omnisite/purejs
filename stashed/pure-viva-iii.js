        ...
        (function BaseSysModel() {
            return {
                ...
                func: {
                    ...
                    ext: [
                        (function MakeAP() {
                            ...
                            (function $ap(accum, bind, tmpl, make) {
                                return function $ap(fmap, faccum) {
                                    return tmpl(bind(fmap, accum(faccum || unit)));
                                }
                            }),
                            (function add(f) {
                                return function(x, b) {
                ...
                ext: {
                    ...
                    array: [
                        'ap', 'fmap', 'frun', 'bind', 'fold', 'lift', 'combine'
                    ]
                },
                model: {
                    store: [
                ...
                factory: {
                    ...
                    inherit: function(type, parent) {
                        ...
                        proto = this.ext(proto, type.ext, model);
                        if (type.attrs)   this.ext(type.klass, type.attrs, model);
...
// ========  ======== STAGE TYPES ========  ======== //
    ...
    (function Types() {
        ...
        (function Types() {
            return [].slice.call(arguments).reduce(function(r, x) {
                r[x.name] = x;
                return r;
            }, (sys.model('types')));
        }),
