                        ...
                        (function fn(key) {
                            ...
                            return node[key] && node[key] instanceof Function
                                && (node.constructor.prototype[key] instanceof Function)
                                    ? node[key].bind(node) : (node.is(node.get(key)) ? node.get(key) : null);
                        }),
                        (function bind(f) {
            ...
            (function() {
                return {
                    ...
                    ext: [
                        ...
                        (function start() {
                            if (!this._started && (this._started = true)) {
                                this._data.observe('change', '%', this.change.bind(this));
                            }
                        }),
                        (function change(evt) {
                            console.log(evt);
                    ...
                    init: function(type, klass) {
                        ...
                        klass.prototype._started = false;
    ...
    (function MakeBind() {
        ...
        (function next() {
            ...
            (function make($bind, $map) {
                return function next(x) {// f (FUN(x,(ys,N),M))
    ...
    (function Effects() {
        ...
        [ (function CreateSetup(createInstruction, createHandler, createFn, createEnv, createEffects) {
            return function(root, sys) {
                return root.$fn('fn.child')('effects', createEnv.call(
