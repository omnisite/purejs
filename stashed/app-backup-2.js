            ...
            (function() {
                return {
                    ...
                    ext: (function() {
                        ...
                        (function add(/* type, name, element, selector, run, throttle */) {
                            ...
                            return node.add(handler,
                                ...
                                )(this.fromCallback)(throttle ? this.throttle(handler, throttle) : handler)
                            );
                        }),
                    ...
                    attrs: [
                        (function init(type) {
                            ...
                            return function(elem) {
                                ...
                                var fcb  = func.fromCallback(node.get('dispatcher')(node.get('listener')));
                    ...
                    init: function(type, klass) {
                        ...
                        var dom   = sys.type('Listener').init('dom')(document.body);
